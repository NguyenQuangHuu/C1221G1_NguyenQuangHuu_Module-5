package vn.codegym.pharmacy_project.config.oauth2;
...
import vn.codegym.pharmacy_project.config.oauth2.user.OAuth2UserInfo;
import vn.codegym.pharmacy_project.config.oauth2.user.OAuth2UserInfoFactory;
...
import vn.codegym.pharmacy_project.service.impl.UserDetailsImpl;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        Optional<Users> users = this.iUsersRepository.findByUsername(oAuth2UserInfo.getEmail());
        Users user;
        if(users.isPresent()){
            user = users.get();
    ...
    private Users updateExistingUser(Users existingUser, OAuth2UserInfo oAuth2UserInfo) {
        ...
        return this.iUsersRepository.save(existingUser);
    }
}
